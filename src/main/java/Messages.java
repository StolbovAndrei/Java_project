public class Messages {
    ...
    public static final String BACK_MESSAGE = "Вы вышли в меню, ожидаю команды! /help для помощи";
    public static final String SEARCH_MESSAGE = "Введите имя исполнителя и название трека для поиска: ";
}
